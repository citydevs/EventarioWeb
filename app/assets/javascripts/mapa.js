...
card = function(point) {
  ...
  return div_card_centro = "<div class='col-md-12 box1'>"+"<div class='card '><table  WIDTH=100% border=0px heigth=20px><thead><tr></tr></thead> <tbody><tr><td width='8%'> <img src=/categorias/"+point.categoria+".png width='23' height='23' /></td><td width='92%'><font color='#076FEF'>" +point.categoria+"&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp"+distancia+"</font></td></tr> <tr> <td width='8%'></td><td width='92%'>"+nombre_centro+"</td></tr><tr> <td width='8%'><img src='donde.png' width='23' height='23' /></td><td width='92%'>"+ point.lugar+"</td></tr><tr> <td width='8%'><img src='fecha.png' width='23' height='23' /></td><td width='92%'>"+ nf1+" - "+nf2+"</td></tr><tr> <td width='8%'><img src='hora.png' width='23' height='23' /></td><td width='92%'>"+ f1+" - "+f2+"</td></tr></tbody></table><div class='space'></div></div></div>";
};
